...
@interface JBWLAppointCourseController ()<UITableViewDelegate,UITableViewDataSource>
@property (nonatomic,strong)UITableView *courseOrderTableView;
@property (nonatomic,assign)BOOL isFirstLoad;
@end

@implementation JBWLAppointCourseController
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    JBWLCourseDetailController *courseDetail = [[JBWLCourseDetailController alloc] init];
    [self.managerVC.navigationController pushViewController:courseDetail animated:YES];
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (self.orderType == JBWLAppointCourseOrderAll) {
